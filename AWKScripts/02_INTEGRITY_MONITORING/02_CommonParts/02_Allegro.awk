...
function Allegro(){
	AllegroCMD_01 = CALL_BUSYBOX" sh ShellScripts/02_INTEGRITY_MONITORING/02_CALL_INTEGRITY_MONITORING_Allegro_01.sh";
	ExecCmd(AllegroCMD_01);
	Allegro_Sub01();
	AllegroCMD_15 = CALL_BUSYBOX" sh ShellScripts/02_INTEGRITY_MONITORING/03_CALL_INTEGRITY_MONITORING_Allegro_02.sh";
...
function Allegro_Sub01(){
	...
	if(Allegro_Sub01_RC_UTF8 != 0 || Allegro_Sub01_RC_SJIS != 0 || Allegro_Sub01_RC_EDIT != 0 || Allegro_Sub01_RC_XLSX != 0 || Allegro_Sub01_RC_CSV != 0 || Allegro_Sub01_RC_HASH != 0){
		AllegroCMD_08 = CALL_BUSYBOX" sh ShellScripts/01_UPDATE/01_CALL_UPDATE.sh";
