...
function Allegro_Sub18(Allegro_Sub18_CMD01){
	Allegro_Sub18_CMD01 = CALL_BUSYBOX" sh ShellScripts/08_CALL_DETECTOR_Allegro_02.sh";
...
function Allegro_Sub19(Allegro_Sub19_CMD01,Allegro_Sub19_CMD02){
	if(Allegro_Sub07_BitField_CSV == 1){
		Allegro_Sub19_CMD01 = CALL_BUSYBOX" sh ShellScripts/09_CALL_DETECTOR_Allegro_03.sh";
		ExecCmd(Allegro_Sub19_CMD01);
	}
	if(Allegro_Sub07_BitField_TSV == 1){
		Allegro_Sub19_CMD02 = CALL_BUSYBOX" sh ShellScripts/10_CALL_DETECTOR_Allegro_04.sh";
...
function Allegro_Sub20(Allegro_Sub20_CMD01){
	Allegro_Sub20_CMD01 = CALL_BUSYBOX" sh ShellScripts/11_CALL_DETECTOR_Allegro_05.sh";
